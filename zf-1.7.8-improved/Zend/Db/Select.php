...
class Zend_Db_Select
{
    ...
    public function _joinUsing($type, $name, $cond, $cols = '*', $schema = null)
    {
        ...
        $join  = $this->_adapter->quoteIdentifier(key( array_slice( $this->_parts[self::FROM], -1, 1, TRUE ) ), true);
        $from  = $this->_adapter->quoteIdentifier($this->_uniqueCorrelation(key($name)), true);
